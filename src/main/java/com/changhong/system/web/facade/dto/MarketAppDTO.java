...
public class MarketAppDTO implements Serializable {
    ...
    //vip groups
    private boolean vip;
    private List<VipGroupDTO> groups;
    ...
    public MarketAppDTO(int id, String appKey, String appName, String appDescription, String appNote, String appVersionInt, String appVersion, String appPackage,
        ...
        if (this.groups != null) {
            for (VipGroupDTO group : this.groups) {
                builder1.append(group.getId() + ",");
            }
        }
        this.groupIds = builder1.toString();
    }
    ...
    public List<VipGroupDTO> getGroups() {
        return groups;
    }

    public void setGroups(List<VipGroupDTO> groups) {
        this.groups = groups;
    }
