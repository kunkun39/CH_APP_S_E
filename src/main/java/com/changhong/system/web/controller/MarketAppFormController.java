...
public class MarketAppFormController extends SimpleFormController {
    ...
    protected Object formBackingObject(HttpServletRequest request) throws Exception {
        ...
        List<VipGroupDTO> vipGroups = userService.obtainAllVipGroups();
        request.setAttribute("groups", vipGroups);
...
//            }
    ...
    protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws Exception {
        ...
        String addGroups = ServletRequestUtils.getStringParameter(request, "addGroups", "");
        String deleteGroups = ServletRequestUtils.getStringParameter(request, "deleteGroups", "");
        app.setAddGroups(addGroups);
        app.setDeleteGroups(deleteGroups);
