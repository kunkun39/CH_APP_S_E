...
public class MarketOverviewPaging extends AbstractPaging<MarketAppDTO> {
    ...
    public List<MarketAppDTO> getItems() {
        return appService.obtainMarketApps(appName, categoryId, topicId, groupId, appStatus, getStartPosition(), getPageSize());
    }
    ...
    public long getTotalItemSize() {
        ...
        totalItemSize = appService.obtainMarketAppSize(appName, categoryId, topicId, groupId, appStatus);
        return totalItemSize;
    }

    public String getParameterValues() {
        return "&appName=" + getAppName() + "&categoryId=" + getCategoryId() + "&topicId=" + getTopicId() + "&groupId=" + getGroupId() + "&appStatus=" + getAppStatus();
    }
