...
public interface AppService {
    ...
    List<MarketAppDTO> obtainMarketApps(String appName, int categoryId, int topicId, int groupId, String appStatus, int startPosition, int pageSize);

    int obtainMarketAppSize(String appName, int categoryId, int topicId, int groupId, String appStatus);
