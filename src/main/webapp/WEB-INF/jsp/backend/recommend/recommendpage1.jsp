...
<div id="part_1" class="tv_main_bg">
    <div class="tv_main">
        ...
        <div class="centerside">
            ...
            <div class="preview1">
                <div class="wrap1">
                    <ch:recommend pageNumber="1" recommendPosition="2" fileRequestHost="${fileRequestHost}" recommends="${recommends}" subString="true"/>
                </div>
                <div class="wrap1">
                    <ch:recommend pageNumber="1" recommendPosition="3" fileRequestHost="${fileRequestHost}" recommends="${recommends}" subString="true"/>
                </div>
            </div>
            ...
            <div class="preview2">
                <div>
                    <div class="wrap2">
                        <ch:recommend pageNumber="1" recommendPosition="4" fileRequestHost="${fileRequestHost}" recommends="${recommends}" subString="true"/>
                    </div>
                    <div class="wrap2">
                        <ch:recommend pageNumber="1" recommendPosition="5" fileRequestHost="${fileRequestHost}" recommends="${recommends}" subString="true"/>
                    </div>
                </div>
            </div>
