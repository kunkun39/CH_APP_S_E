...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
        <a href="javascript:void(0);" class="tip-bottom"><i class="icon-home"></i> Dasboard</a>
        <a href="javascript:void(0);" class="current">Password Change</a>
        </div>
    </div>
                    ...
                    <div class="widget-content nopadding">
                        <spring-form:form commandName="userPassword" class="form-horizontal" method="post" name="basic_validate" id="basic_validate" novalidate="novalidate">
                            ...
                            <div class="form-actions">
                                <input type="button" value="Back" class="btn btn-success" onclick="window.location.href='${pageContext.request.contextPath}/backend/dashboard.html'">
                                &nbsp;
