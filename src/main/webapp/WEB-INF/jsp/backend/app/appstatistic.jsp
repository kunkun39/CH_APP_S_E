...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a style="font-size: 13px" href="${pageContext.request.contextPath}/backend/dashboard.html" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a style="font-size: 13px" href="javascript:void(0);" class="current">App Download Statistic</a> </div>
  </div>
...
<script type="text/javascript">
    ...
    function renew_column_container(categoryId, year, month) {
        if("0" == month) {
            ...
            SystemDWRHandler.obtainAppDownloadColumnData(categoryId, year, month, function(result) {
                ...
                app_column_sta_container.xAxis.categories = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'June', 'July', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec'];
                ...
                app_column_sta_container.title.text = "End User Download App Statistic";
    ...
    function renew_pie_container(categoryId, year, month) {
        SystemDWRHandler.obtainAppDownloadPienData(categoryId, year, month, function(result) {
            ...
            app_pie_sta_container.title.text = "End User Download App Statistic";
