...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="${pageContext.request.contextPath}/backend/dashboard.html" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="javascript:void(0);" class="current">App Topic Management</a> </div>
  </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        <div class="widget-title">
            ...
            <h5>App Topic Management [Notice:for better user experience, it's better control topic number under 20]</h5>
        </div>
...
<div id="topic_delete_dialog" title="System Confirm Dialog?" style="visibility: hidden;">
    <p>
        <span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>
        Are you sure you want to delete this topic from the system?
    </p>
</div>
